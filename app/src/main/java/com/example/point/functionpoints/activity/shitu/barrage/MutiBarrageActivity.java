...
import com.example.point.functionpoints.view.barrage.adapter.AdapterListener;
 ...
 */
public class MutiBarrageActivity extends TitleActivity {
    ...
    private void initBarrage(){
        ...
        barrageView.setAdapter(mAdapter = new BarrageAdapter<BarrageData>(null, this) {
            ...
            public BarrageViewHolder<BarrageData> onCreateViewHolder(View root, int type) {
                switch (type) {
                    case R.layout.item_barrage_text:
                    case R.layout.item_barrage_text_vip:
            ...
            public int getItemLayout(BarrageData barrageData) {
                switch (barrageData.getType()) {
                    case 0:
                        return R.layout.item_barrage_text;
                    case 1:
                        return R.layout.item_barrage_text_vip;
                    default:
                        return R.layout.item_barrage_big;
                }
            }
        });
        // 设置监听器
