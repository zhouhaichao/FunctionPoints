...
public class SlideMenu extends FrameLayout {
    ...
    public enum DragState {Open, Close}
    ...
    private void initData() { // 父View、滑动敏感度、回调方法
        mViewDragHelper = ViewDragHelper.create(this, callback); // 浮点运算器
        mFloatEvaluator = new FloatEvaluator(); // 颜色运算器
    ...
    ViewDragHelper.Callback callback = new ViewDragHelper.Callback() {
         ...
         */
        @Override
        public boolean tryCaptureView(View child, int pointerId) { // 捕获mainView和menuView的触摸事件
