    ...
    class TabView extends LinearLayout {
        ...
        final void update() {
            ...
            if (mCustomView == null) {
                ...
                if (mIconView == null) {
                    ImageView iconView = new ImageView(getContext());//android:scaleType="centerInside"
                ...
                if (mTextView == null) {
                    TextView textView = new TextView(getContext());//android:ellipsize="end" android:gravity="center" android:maxLines="2"
